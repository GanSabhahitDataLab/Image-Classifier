...
def nn_setup(structure='densenet121',dropout=0.5, hidden_layer1 = 120,lr = 0.001):
    '''
    ...
    if structure == 'vgg16':
        ...
        print("Enter one of vgg16,densenet121,or alexnet?".format(structure))
...
def train_network(model, criterion, optimizer, loader,epochs = 3, print_every=20):
    '''
...
def save_checkpoint(path='./mycheckpoint.pth',structure ='densenet121', hidden_layer1=120,dropout=0.5,lr=0.001,epochs=12):
    '''
...
def load_checkpoint(path='./mycheckpoint.pth'):
    '''
